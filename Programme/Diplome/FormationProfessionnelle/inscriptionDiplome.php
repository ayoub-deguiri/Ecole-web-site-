      ...
      <form action="" method="POST">
         ...
         <div class="mb-3 radio">
            ...
            <div class="form-check">
               <input type="radio" class="form-check-input" value="9AEF" name='niveau' id="r4">
               <label class="form-check-label label-radio"> 9AEF</label>
            </div>
            <div class="form-check">
               <input type="radio" class="form-check-input" value="2ème Année BAC" name='niveau' id="r3">
               <label class="form-check-label label-radio">2ème Année BAC</label>
            </div>

            <div class="form-check">
               <input type="radio" class="form-check-input" value=" BAC ou plus " name='niveau' id="r2">
