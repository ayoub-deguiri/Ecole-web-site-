...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   $pdo_statement = $pdo_conn->prepare("INSERT INTO inscription values(null,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,null)");
...
<head>
   ...
   <title>inscription diplome</title>
      ...
      <form action="" method="POST" enctype='multipart/form-data'>
         ...
         <div class="mb-3 radio">
            ...
            <div class="form-check">
               <input type="radio" class="form-check-input sel_depart" value="9AEF" name='niveau' id="r4">
               <label class="form-check-label label-radio"> 9AEF</label>
            </div>
            <div class="form-check">
               <input type="radio" class="form-check-input sel_depart" value="2BAC" name='niveau' id="r3">
               <label class="form-check-label label-radio">2ème Année BAC</label>
            </div>

            <div class="form-check">
               <input type="radio" class="form-check-input sel_depart" value="BACOUPlus" name='niveau' id="r2">
               <label class="form-check-label label-radio" for="radio2"> BAC ou Plus </label>
            </div>
