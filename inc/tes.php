    ...
    <script>
        $(document).ready(function () {
            ...
            $("#valider").click(function (ev) {
                if ($('#groupe').val() === null) {
                    ev.preventDefault()
                    $("#année-scolaire").css("border", "2px solid red");
                    $("#groupe").css("border", "2px solid red");
                    $("#filiére").css("border", "2px solid red");
                    $("#année").css("border", "2px solid red");
                }
            })
            //  update responsable
...
<body>
    <header>
        <div class="logoApp">
            <img src="./images/logoApp.png" alt="logoApp" id="logoApp" />
        </div>
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                <li class="Acceuil">
                    <a href="./Accueil-serveillant.php"><i class="fa fa-home" aria-hidden="true"></i> Acceuil </a>
                    <u></u>
                </li>
                <li class="has-dropdown">
                    <a href="./Modifier-Stagiaire.php"><i class="fa fa-pencil-square" aria-hidden="true"></i>
                        Stagiaire <span><img src="./images/caret.svg" alt=""></span></a>
                    <ul class="dropdown">
                        <li class="dropdown-item"><a href="./Affichage-surveillant.php">Modifier Stagiaire</a></li>
                        <li class="dropdown-item"><a href="./SasireAbsence-surveillant.php">Changer Groupe</a></li>
                    </ul>
                </li>
                <li class="has-dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-calendar-times-o"
                            aria-hidden="true"></i> Absence <span><img src="./images/caret.svg" alt=""></span></a>
                    <ul class="dropdown">
                        <li class="dropdown-item"><a href="./Affichage-surveillant.php"> Affichage</a></li>
                        <li class="dropdown-item"><a href="./SasireAbsence-surveillant.php"> Saisie</a></li>
                    </ul>
                </li>
                <li>
                    <a href="./Absence_Justifier.php">
                        <i class="fa fa-check-square-o" aria-hidden="true"></i> Justification</a> <u></u>
                </li>
                <li>
                    <a href="./note.php"><i class="fa fa-calculator" aria-hidden="true"></i> Notes </a> <u></u>
                </li>
                <li class="Deperdition">
                    <a href="./Deperdition.php"><i class="fa fa-archive" aria-hidden="true"></i> Déperdition </a>
                    <u></u>
                </li>
                <li id="log-out">
    ...
    <div class="listeEtudiants">
        <form id='table-form'>
            ...
            ?>
            <table>
                <caption> <span>Group : <?= $group['nomGroupe'] ?></span>
    ...
    <div id="myModal" class="modal1" role="dialog">
